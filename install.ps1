...
Write-Host "🚀 Installing andy-universal-agent-rules..." -ForegroundColor Cyan
Write-Host ""

# Check if .agent folder already exists
if (Test-Path ".agent") {
    $confirm = Read-Host "⚠️  .agent folder already exists! Overwrite? (y/N)"
...
Write-Host "📥 Downloading context files..." -ForegroundColor Yellow
try {
...
if (-not (Test-Path "AGENTS.md")) {
    Write-Host "📝 Creating AGENTS.md..." -ForegroundColor Yellow
    $agentsMd = @'
# AGENTS.md
