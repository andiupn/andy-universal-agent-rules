...
```bash
# Option 1: Via script
python .agent/scripts/save-knowledge.py --category [kategori] "[content]"
...
- [ ] **Sync AGENTS.md statistics** (`python .agent/scripts/sync-agents-stats.py`)
...
python .agent/scripts/migrate-knowledge-folder.py _o.knowledge/
```
...
3. **Sync Stats** - Jalankan `python .agent/scripts/sync-agents-stats.py`
